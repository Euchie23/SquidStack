...
- [`trace_metals.csv`](https://raw.githubusercontent.com/Euchie23/Exploration/master/data/trace_metals.csv): Contains measurements of trace metal pollutants *(Right-click and "Save link as..." to download the CSV file)*
- [`organic_compounds.csv`](https://raw.githubusercontent.com/Euchie23/Exploration/master/data/organic_compounds.csv): Contains measurements of organic compound pollutants *(Right-click and "Save link as..." to download the CSV file)*
